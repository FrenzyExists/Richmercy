          ...
          <div class="relative z-50 flex h-16 items-center">
            <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
              ...
              <div @click="isOpen = !isOpen"
                ...
                <font-awesome-icon class="dark:text-dark-acc-soft text-acc-soft" icon="fa-solid fa-burger" />
              </div>
            </div>
      ...
      <transition name="slide" class="dark:bg-dark-bg-mute bg-bg-mute rounded-b-lg">
        <div v-show="isOpen" class="sm:hidden">
          <div class="space-y-1 px-2 pt-2 pb-3">
            <RouterLink v-for="item in $props.FilteredRoutes" :key="item.name" :to="item.path"

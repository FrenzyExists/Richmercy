          ...
          <div class="grid mld:grid-cols-10 xs:grid-cols-1">
            ...
            <div class="col-span-6">
              ...
              <div>
                ...
                <h4 class="text-4xl dark:text-dark-text-soft text-soft">A <span id="typed"></span></h4>
              </div>
              ...
              <blockquote class="text-lg italic font-semibold mt-3 text-gray-900 dark:text-white">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                  class="block w-5 h-5 dark:text-dark-acc-soft text-acc-soft mb-4" viewBox="0 0 975.036 975.036">
                  <path
...
export default {
  setup() {
    ...
    quote.value = { "q": "Anything that can go wrong will go wrong, and at the worst possible time", "a": "Murphy's Law" }
    return { quote }
  },
  data() {
    return {

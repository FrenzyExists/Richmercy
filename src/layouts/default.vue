    ...
    <div
      ...
      <div class="max-w-prose mx-auto lg:text-lg prose prose-toy-story dark:prose-invert">
        ...
        <div class="flex items-center">
          <aside>
            <a href="#"
              class="no-underline text-red-soft dark:text-dark-red-soft bg-bg-mute dark:bg-dark-bg-mute dark:hover:text-dark-acc-soft dark:hover:bg-dark-bg-super-soft-trans border mr-2 items-center dark:border-dark-bg-hard border-bg-super-soft-trans font-medium text-sm px-3 py-2 rounded-lg inline-flex"><font-awesome-icon
                class="mr-2 dark:text-dark-blue text-blue" icon="fa-brands fa-twitter" /> tweet</a>
            <a href="#"
              class="no-underline text-blue-soft dark:text-dark-blue-soft bg-bg-mute dark:bg-dark-bg-mute dark:hover:text-dark-acc-soft dark:hover:bg-dark-bg-super-soft-trans border mr-2 items-center dark:border-dark-bg-hard border-bg-super-soft-trans font-medium text-sm px-3 py-2 rounded-lg inline-flex"><font-awesome-icon
